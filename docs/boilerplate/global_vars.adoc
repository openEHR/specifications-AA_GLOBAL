...
:specifications_website_url: https://specifications.openehr.org
:openehr_logo: {specifications_website_url}/images/openehr_logo_large.png
:cc_licence_img: {specifications_website_url}/images/cc-by-nd-88x31.png
