...
:openehr_subject_proxy: {openehr_proc_releases}/subject_proxy.html
...
:openehr_proc_latest_subject_proxy: {openehr_proc_latest}/subject_proxy.html
...
:openehr_cnf_scripts_dir: {openehr_cnf_releases}/scripts/openehr_platform
