...
:openehr_am_uml_export: {openehr_am_releases}/docs/UML
...
:openehr_base_releases: {openehr_specs}{openehr_base_releases_loc}
...
:openehr_lang_releases: {openehr_specs}{openehr_lang_releases_loc}
...
:openehr_rm_uml_export: {openehr_rm_releases}/docs/UML
