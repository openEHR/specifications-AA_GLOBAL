...
----
cd ..
docker run --rm -it -u $(id -u):$(id -g) -v "$(pwd):/documents/" asciidoctor bash
----
...
[source]
----
docker run -u $(id -u):$(id -g) -v "$(pwd):/documents/" asciidoctor -f -r -v -t -q -l Release-1.0.1 QUERY
docker run -u $(id -u):$(id -g) -v "$(pwd):/documents/" asciidoctor -f -r -v -t -q -l development RM
----
